...
- **Budget limits**: Each guardrail’s budget is checked independently. See [Budget Enforcement](https://openrouter.ai/docs/guides/features/guardrails#budget-enforcement) for details.
