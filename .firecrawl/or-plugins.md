...
| --- | --- | --- |
| **Web Search** (deprecated) | Augment LLM responses with real-time web search results. Use the [`openrouter:web_search` server tool](https://openrouter.ai/docs/guides/features/server-tools/web-search) instead. | [Web Search](https://openrouter.ai/docs/guides/features/plugins/web-search) |
| **PDF Inputs** | Parse and extract content from uploaded PDF files | [PDF Inputs](https://openrouter.ai/docs/guides/overview/multimodal/pdfs) |
| **Response Healing** | Automatically fix malformed JSON responses from LLMs | [Response Healing](https://openrouter.ai/docs/guides/features/plugins/response-healing) |
| **Context Compression** | Compress prompts that exceed a model’s context window using middle-out truncation | [Message Transforms](https://openrouter.ai/docs/guides/features/message-transforms) |
...
The `:online` variant and the web search plugin are deprecated. Use the [`openrouter:web_search` server tool](https://openrouter.ai/docs/guides/features/server-tools/web-search) instead.
...
See [Model Variants](https://openrouter.ai/docs/guides/routing/model-variants) for more information about available shortcuts.
