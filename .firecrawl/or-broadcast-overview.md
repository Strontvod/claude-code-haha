...
- [Arize AI](https://openrouter.ai/docs/guides/features/broadcast/arize)
- [Braintrust](https://openrouter.ai/docs/guides/features/broadcast/braintrust)
- [ClickHouse](https://openrouter.ai/docs/guides/features/broadcast/clickhouse)
- [Comet Opik](https://openrouter.ai/docs/guides/features/broadcast/opik)
- [Datadog](https://openrouter.ai/docs/guides/features/broadcast/datadog)
- [Grafana Cloud](https://openrouter.ai/docs/guides/features/broadcast/grafana)
- [Langfuse](https://openrouter.ai/docs/guides/features/broadcast/langfuse)
- [LangSmith](https://openrouter.ai/docs/guides/features/broadcast/langsmith)
- [New Relic](https://openrouter.ai/docs/guides/features/broadcast/newrelic)
- [OpenTelemetry Collector](https://openrouter.ai/docs/guides/features/broadcast/otel-collector)
- [PostHog](https://openrouter.ai/docs/guides/features/broadcast/posthog)
- [S3 / S3-Compatible](https://openrouter.ai/docs/guides/features/broadcast/s3)
- [Sentry](https://openrouter.ai/docs/guides/features/broadcast/sentry)
- [Snowflake](https://openrouter.ai/docs/guides/features/broadcast/snowflake)
- [W&B Weave](https://openrouter.ai/docs/guides/features/broadcast/weave)
- [Webhook](https://openrouter.ai/docs/guides/features/broadcast/webhook)
...
- [Langfuse](https://openrouter.ai/docs/guides/features/broadcast/langfuse#custom-metadata) \- Supports trace naming, user/session IDs, and arbitrary metadata
- [LangSmith](https://openrouter.ai/docs/guides/features/broadcast/langsmith#custom-metadata) \- Supports tags, session tracking, and metadata
- [Datadog](https://openrouter.ai/docs/guides/features/broadcast/datadog#custom-metadata) \- Supports tags, user IDs, and session IDs
- [Braintrust](https://openrouter.ai/docs/guides/features/broadcast/braintrust#custom-metadata) \- Supports tags and custom metadata fields
- [W&B Weave](https://openrouter.ai/docs/guides/features/broadcast/weave#custom-metadata) \- Supports custom attributes in trace data
- [Arize AI](https://openrouter.ai/docs/guides/features/broadcast/arize#custom-metadata) \- Supports OpenInference span attributes and metadata
- [Comet Opik](https://openrouter.ai/docs/guides/features/broadcast/opik#custom-metadata) \- Supports trace/span metadata and cost tracking
- [Grafana Cloud](https://openrouter.ai/docs/guides/features/broadcast/grafana#custom-metadata) \- Supports TraceQL-queryable span attributes
- [New Relic](https://openrouter.ai/docs/guides/features/broadcast/newrelic#custom-metadata) \- Supports NRQL-queryable span attributes
- [Sentry](https://openrouter.ai/docs/guides/features/broadcast/sentry#custom-metadata) \- Supports span attributes for performance monitoring
- [OpenTelemetry Collector](https://openrouter.ai/docs/guides/features/broadcast/otel-collector#custom-metadata) \- Supports OTLP span attributes for any backend
- [Webhook](https://openrouter.ai/docs/guides/features/broadcast/webhook#custom-metadata) \- Custom metadata in OTLP JSON payload
- [PostHog](https://openrouter.ai/docs/guides/features/broadcast/posthog#custom-metadata) \- Supports event properties for LLM analytics
- [Snowflake](https://openrouter.ai/docs/guides/features/broadcast/snowflake#custom-metadata) \- Queryable via VARIANT column functions
- [ClickHouse](https://openrouter.ai/docs/guides/features/broadcast/clickhouse#custom-metadata) \- Queryable via JSONExtract functions
- [S3](https://openrouter.ai/docs/guides/features/broadcast/s3#custom-metadata) \- Stored in trace JSON files
...
- [Arize AI](https://openrouter.ai/docs/guides/features/broadcast/arize) \- ML observability and monitoring
- [Braintrust](https://openrouter.ai/docs/guides/features/broadcast/braintrust) \- LLM evaluation and monitoring
- [ClickHouse](https://openrouter.ai/docs/guides/features/broadcast/clickhouse) \- Real-time analytics database
- [Comet Opik](https://openrouter.ai/docs/guides/features/broadcast/opik) \- LLM evaluation and testing
- [Datadog](https://openrouter.ai/docs/guides/features/broadcast/datadog) \- Full-stack monitoring and analytics
- [Grafana Cloud](https://openrouter.ai/docs/guides/features/broadcast/grafana) \- Observability and monitoring platform
- [Langfuse](https://openrouter.ai/docs/guides/features/broadcast/langfuse) \- Open-source LLM engineering platform
- [LangSmith](https://openrouter.ai/docs/guides/features/broadcast/langsmith) \- LangChain observability and debugging
- [New Relic](https://openrouter.ai/docs/guides/features/broadcast/newrelic) \- Full-stack observability platform
- [OpenTelemetry Collector](https://openrouter.ai/docs/guides/features/broadcast/otel-collector) \- Send traces to any OTLP-compatible backend
- [PostHog](https://openrouter.ai/docs/guides/features/broadcast/posthog) \- Product analytics with LLM tracking
- [S3 / S3-Compatible](https://openrouter.ai/docs/guides/features/broadcast/s3) \- Store traces in S3, R2, or compatible storage
- [Sentry](https://openrouter.ai/docs/guides/features/broadcast/sentry) \- Application monitoring and error tracking
- [Snowflake](https://openrouter.ai/docs/guides/features/broadcast/snowflake) \- Cloud data warehouse for analytics
- [W&B Weave](https://openrouter.ai/docs/guides/features/broadcast/weave) \- LLM observability and tracking
- [Webhook](https://openrouter.ai/docs/guides/features/broadcast/webhook) \- Send traces to any HTTP endpoint
